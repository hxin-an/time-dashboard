...
Updated: 2026-05-24T19:55:21+08:00
...
```dataviewjs
const raw = await dv.io.load("life/worklog/data/time_daily_stats_2026-05.json");
const data = JSON.parse(raw);
let prevData = {days: []};
try {
  const prevRaw = await dv.io.load("life/worklog/data/time_daily_stats_2026-04.json");
